...
class Yolov4Node(object):
    def __init__(self, cfgfile, weightfile):
        ...
        self.sub_image = rospy.Subscriber("/camera/color/image_raw", ROSImage, self.image_cb, queue_size=1)
    ...
    def srv_cb(self, req):
        ...
        result_img = plot_boxes_cv2(cv_image, boxes, savename=None, class_names=self.class_names)
