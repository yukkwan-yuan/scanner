...
class DetectedImgNode(object):
    def __init__(self, cfgfile, weightfile):
        ...
        self.sub_img = rospy.Subscriber("/camera3/color/image_raw", ROSImage, self.img_callback, queue_size=1)
    ...
    def srv_callback(self, req):
        ...
        if num_classes == 20:
            ...
            namesfile = os.path.join(os.path.dirname(__file__), './data/obj.names')
        ...
        # rospy.logwarn("return %d detection results", len(boxes))
...
if __name__ == '__main__':
    ...
    rospy.init_node('DetectedPersonImgNode', anonymous=False)       
