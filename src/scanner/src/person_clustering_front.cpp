...
ScanImageCombineNode::ScanImageCombineNode(ros::NodeHandle nh, ros::NodeHandle pnh): nh_(nh), pnh_(pnh)
{
    ...
    ros::param::param<string>("~scan_topic", scan_topic, "/scan_person_front_pointcloud_filtered");
    ...
    pub_combined_image_ = nh.advertise<sensor_msgs::Image>("/scan_person_clustering_front_node/debug_reprojection", 1);
    pub_marker_array_ = nh.advertise<visualization_msgs::MarkerArray>("/scan_person_clustering_front_node/obj_marker", 1);
    pub_colored_pc_ = nh.advertise<sensor_msgs::PointCloud2>("/scan_person_clustering_front_node/colored_pc", 1);
    pub_detection3d_ = nh.advertise<detection_msgs::Det3DArray>("/scan_person_clustering_front_node/det3d_result", 1);
...
{
    ros::init(argc, argv, "scan_person_clustering_front_node");
